...
@DefaultUrl("https://www.hpb.gov.sg/partners")
public class PartnershipPage extends PageObject {

    private static Logger log = LogManager.getLogger(PartnershipPage.class);
